...
void pointersExample()  {
	...
	*pointer=*pointer+1; /*In pointers, we cannot user *pointer++ because changes the pointer memory address */

	printf("Some number address = %x\n", &someNumber);
	printf("Some number value = %d\n", someNumber);
...
void mainMenu(int argc, char *argv[]) {
	...
	printf("9 - Pointers example.\n");
	printf("10 - Preprocessors example.\n");
